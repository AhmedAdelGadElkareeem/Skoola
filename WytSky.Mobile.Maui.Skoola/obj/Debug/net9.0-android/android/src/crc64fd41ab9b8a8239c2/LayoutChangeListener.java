...
/** @hide */
	...
	public LayoutChangeListener (org.videolan.libvlc.AWindow p0)
	{
		super ();
		if (getClass () == LayoutChangeListener.class) {
			mono.android.TypeManager.Activate ("LibVLCSharp.Platforms.Android.LayoutChangeListener, LibVLCSharp", "Org.Videolan.Libvlc.AWindow, LibVLCSharp.Android.AWindowModern", this, new java.lang.Object[] { p0 });
		}
	}
