...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "WytSky.Mobile.Maui.Skoola.dll" comes first in this list. */
		"WytSky.Mobile.Maui.Skoola.dll",
		...
		"GoogleGson.dll",
		"LibVLCSharp.dll",
		"LibVLCSharp.Android.AWindowModern.dll",
		"LibVLCSharp.MAUI.dll",
		...
		"LibVLCSharp.MAUI.resources.dll",
